...
async def chk_usr(_, message: Message):
    ...
    if (
        ...
        changes.append(
            f"{first_name} {lastname_before} ʜᴀꜱ ᴄʜᴀɴɢᴇᴅ ᴛʜᴇɪʀ ғʀᴏᴍ {first_name} {lastname_before} ᴛᴏ {message.from_user.first_name} {message.from_user.last_name}\n"
        )
    elif first_name != message.from_user.first_name:
        changes.append(
            f"{first_name} ʜᴀꜱ ᴄʜᴀɴɢᴇᴅ ᴛʜᴇɪʀ ғɪʀsᴛ ɴᴀᴍᴇ ғʀᴏᴍ {first_name} ᴛᴏ {message.from_user.first_name}\n"
        )
    elif lastname_before != message.from_user.last_name:
        changes.append(
            f"{lastname_before} ʜᴀꜱ ᴄʜᴀɴɢᴇᴅ ᴛʜᴇɪʀ ʟᴀsᴛ ɴᴀᴍᴇ ғʀᴏᴍ {lastname_before} ᴛᴏ {message.from_user.last_name}\n"
        )

    if usernamebefore != message.from_user.username:
        changes.append(
            f"@{usernamebefore} ʜᴀꜱ ᴄʜᴀɴɢᴇᴅ ᴛʜᴇɪʀ ᴜsᴇʀɴᴀᴍᴇ ғʀᴏᴍ @{usernamebefore} ᴛᴏ @{message.from_user.username}\n"
        )
